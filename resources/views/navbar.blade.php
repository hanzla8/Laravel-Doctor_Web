			  ...
			  <li class="nav-item active">
			   ...
			   <li class="nav-item"><a class="nav-link" href="/about">About</a></li>
				...
				<li class="nav-item"><a class="nav-link" href="/department">Departments</a></li>
			  	...
			  	<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="/doctors" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Doctors <i class="icofont-thin-down"></i></a>
			   ...
			   <li class="nav-item"><a class="nav-link" href="/contact">Contact</a></li>
				 ...
				 @else
					...
					<li class="nav-item" id="register"><a href="{{ route('register') }}" class="nav-link">register</a></li>
				 @endauth
			</ul>
		  </div>
		</div>
