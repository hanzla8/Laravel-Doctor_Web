                 ...
                 <!-- form message -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                         ...
                         <div class="col-lg-6">
                            <div class="form-group">
                                <input name="number" id="phone" type="text" class="form-control" placeholder="Your Phone Number">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <button class="btn btn-main btn-round-full" name="submit" type="submit">Submit</button>
                    </div>
                </form>
            </div>
        </div>
